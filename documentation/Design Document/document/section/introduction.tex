...
\begin{itemize}
    ...
    \item What is LTE? \\ \url{https://www.telekom.com/en/company/details/the-nine-most-important-facts-about-lte-606446}
    \item Severe Weather Alerts API \\ \url{https://www.weatherbit.io/api/alerts}
    \item What Is Model-View-Controller (MVC)? \\ \url{https://www.oracle.com/technical-resources/articles/javase/application-design-with-mvc.html}
\end{itemize}
