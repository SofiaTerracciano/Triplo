...
\begin{itemize}
    \item \label{GPS} Generic term used in this document to indicate satellite-based positioning systems available on the device (such as GPS, Galileo, and others)
