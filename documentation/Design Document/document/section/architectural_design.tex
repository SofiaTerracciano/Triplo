...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=\linewidth]{./images/mobile app component diagram 3.png}
...
\subsubsection{Smartphone Application External Libraries}
...
\begin{itemize}
\item avoids handling user credentials on the smartwatch, reducing the exposure of sensitive data on a constrained and potentially less secure device 
...
\item avoids the need to enforce specific authentication methods, such as Google Sign-In, on the smartwatch, allowing the authentication process to remain centralized on the smartphone.
\end{itemize}
