...
abstract class AppLocalizations {
  ...
  /// No description provided for @photo_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Photo Hunt'**
  String get photo_title_challeng;

  /// No description provided for @photo_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'Take a photo of something special during the route, like a waterfall, an animal, or a rare flower.'**
  String get photo_description_challeng;

  /// No description provided for @time_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Beat the Clock'**
  String get time_title_challeng;

  /// No description provided for @time_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'Complete the route within the estimated time. Can you beat the clock?'**
  String get time_description_challeng;

  /// No description provided for @hi_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Greetings on the Way'**
  String get hi_title_challeng;

  /// No description provided for @hi_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'Greet at least 4 people you meet along the route. Socialize and win!'**
  String get hi_description_challeng;

  /// No description provided for @orientiring_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Mini‑Orienteering'**
  String get orientiring_title_challeng;

  /// No description provided for @orientiring_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'When you reach a certain position, the app will ask you which direction you are going (North, South, East, West). Answer correctly to win the challenge.'**
  String get orientiring_description_challeng;

  /// No description provided for @silent_walking_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Silent Walk'**
  String get silent_walking_title_challeng;

  /// No description provided for @silent_walking_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'Walk silently for a set amount of time. You will receive a notification from your smart watch and need to confirm you completed the challenge.'**
  String get silent_walking_description_challeng;

  /// No description provided for @balance_title_challeng.
  ///
  /// In en, this message translates to:
  /// **'Balance Challenge'**
  String get balance_title_challeng;

  /// No description provided for @balance_description_challeng.
  ///
  /// In en, this message translates to:
  /// **'Find a stone or a root and maintain your balance for a set period of time. Test your balance!'**
  String get balance_description_challeng;
}
